...
int main(long argc, char *argv[]){
    ...
    //prlongf("Enter the size of the longerior mesh:\n");  //
    //scanf("%d%lf%lf%lf%lf",&R,&Tb,&Tt,&Tl,&Tr);
    long MESH[R][R];
    long ii,jj;
    for(jj=0;jj<R;jj++){
        for(ii=0;ii<R;ii++){
    ...
    //prlongf("Enter the value of tempertaure at bottom boundary:\n");  //
    //scanf("%lf",&Tb);
    //prlongf("Enter the value of tempertaure at top boundary:\n");
    //scanf("%lf",&Tt);
    //prlongf("Enter the value of tempertaure at left boundary:\n");
    //scanf("%lf",&Tl);
    //prlongf("Enter the value of tempertaure at right boundary:\n");
    //scanf("%lf",&Tr);
